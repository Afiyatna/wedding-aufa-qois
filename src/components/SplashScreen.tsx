...
export const SplashScreen: React.FC<SplashScreenProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    const phases = [
      { delay: 500, duration: 1000 }, // Names appear
      { delay: 1500, duration: 1000 }, // Heart animation
      { delay: 2500, duration: 500 }   // Fade out
    ];
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-rose-100 via-pink-50 to-rose-200 flex items-center justify-center z-50 transition-opacity duration-1000">
