      ...
      <div className="container mx-auto px-4 sm:px-6 w-full">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ease-out ${
          ...
          <div className="mb-8 sm:mb-12 flex justify-center items-center space-x-3 sm:space-x-4">
            <div className={`w-12 sm:w-16 h-px ${isDark ? 'bg-gray-600' : 'bg-maroon-200'}`}></div>
            <div className={`w-1.5 sm:w-2 h-1.5 sm:h-2 rounded-full ${isDark ? 'bg-maroon-400' : 'bg-maroon-400'}`}></div>
            <div className={`w-3 sm:w-4 h-px ${isDark ? 'bg-gray-600' : 'bg-maroon-200'}`}></div>
            <div className={`w-1.5 sm:w-2 h-1.5 sm:h-2 rounded-full ${isDark ? 'bg-maroon-400' : 'bg-maroon-400'}`}></div>
            <div className={`w-12 sm:w-16 h-px ${isDark ? 'bg-gray-600' : 'bg-maroon-200'}`}></div>
          </div>
          ...
          <div className="mt-8 sm:mt-12 space-y-6 sm:space-y-10">
            ...
            <div className={`relative max-w-md mx-auto p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl ${
              ...
              <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-maroon-100 bg-gradient-to-br from-maroon-100 to-white flex items-center justify-center shadow-inner overflow-hidden">
                  {weddingData.couple.bride.image && !brideImageError ? (
                    ...
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-maroon-500 to-maroon-300 flex items-center justify-center text-2xl sm:text-3xl font-serif text-white">
            ...
            <div className="flex justify-center">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-maroon-200 flex items-center justify-center text-maroon-500 text-sm sm:text-base">
                &
              </div>
            </div>
