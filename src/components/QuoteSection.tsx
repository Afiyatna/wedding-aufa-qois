      ...
      {(shouldAnimate) => (
        <div className="container mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-4xl mx-auto text-center">
            {/* Decorative elements */}
            <AnimateIn shouldAnimate={shouldAnimate} from="top" delay={100} className="mb-8 sm:mb-12 flex justify-center items-center space-x-3 sm:space-x-4">
            ...
            <div className="mt-8 sm:mt-12 space-y-6 sm:space-y-10">
              {/* Bride */}
              <AnimateIn shouldAnimate={shouldAnimate} from="left" delay={500}>
                <div className={`relative max-w-md mx-auto p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl ${isDark ? 'bg-gray-800/90 border border-gray-700' : 'bg-white/95 border border-rose-100'
                  }`}>
                  <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                    ...
                    <h3 className={`text-xl sm:text-2xl md:text-3xl font-serif px-2 ${isDark ? 'text-white' : 'text-gray-800'
                      }`}>
              ...
              {/* Separator */}
              <AnimateIn shouldAnimate={shouldAnimate} delay={600} className="flex justify-center">
              ...
              {/* Groom */}
              <AnimateIn shouldAnimate={shouldAnimate} from="right" delay={700}>
                <div className={`relative max-w-md mx-auto p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl ${isDark ? 'bg-gray-800/90 border border-gray-700' : 'bg-white/95 border border-rose-100'
                  }`}>
                  <div className="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                    <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-rose-100 bg-gradient-to-br from-rose-100 to-white flex items-center justify-center shadow-inner overflow-hidden">
